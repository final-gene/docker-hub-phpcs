...
```bash
$ git clone git@github.com:finalgene/docker-hub-phpcs.git
```

- Or via HTTPS:

```bash
$ git clone https://github.com/finalgene/docker-hub-phpcs.git
```
...
2. Fork the repository (http://github.com/finalgene/docker-hub-phpcs)
...
```bash
$ git remote add {username} git@github.com:{username}/docker-hub-phpcs.git
$ git fetch {username}
```
...
To ssh://git@github.com/{username}/docker-hub-phpcs.git
